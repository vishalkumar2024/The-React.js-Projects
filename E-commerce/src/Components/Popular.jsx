...
function Popular() {
    ...
    return (
        <div id="popular" className='flex flex-col items-center gap-2  mb-4'>
            <h1 id="small-screen" className='smallScreen uppercase text-[#171717]  mt-7 text-[50px] font-bold max-sm:text-[32px] max-lg:text-[30px] overflow-hidden'>popular in women</h1>
