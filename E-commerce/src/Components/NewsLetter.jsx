        ...
        <div className='w-[80%] h-[60vh] bg-linear-to-b from-[#fde1ff] to-[#e1ffea22] flex justify-center
         items-center flex-col gap-7 m-auto   px-[140px] mb-[150px] '>
            ...
            <form
                action="/newslater"
                method="post"
                className='flex items-center justify-between w-[730px] h-[70px] text-white rounded-4xl border border-[#b9b2b2]'>
                <input
                    type="text"
                ...
                <input
                    type="submit"
                    value="Subscribe"
                    className='w-[210px] h-[70px] rounded-4xl bg-black text-white text-4 cursor-pointer'
                />
            </form>
        </div>
    )
