...
function Navbar() {
    ...
    return (
        <>
            <div className='flex justify-around bg-[#fbcae9] fixed w-full p-2 z-50 shadow-black shadow max-md:justify-between'>
                ...
                <div className=' py-2'>
                    ...
                    <div id="mobileMenu" className={`${menuBar ? "fixed" : "hidden"} bg-[rgba(255,75,210,0.41)] p-2.5 mt-4.5  md:hidden max-sm:w-[120px] `}>
                        <ul>
                            <Link to="/men"> <li className='h-10 w-[120px] py-2 px-3 hover:bg-pink-400 max-sm:w-[100%] '>Men</li></Link>
                            <Link to="/women"><li className='h-10 w-[120px] py-2 px-3 hover:bg-pink-400 max-sm:w-[100%] '>Women</li></Link>
                            <Link to="/kid"><li className='h-10 w-[120px] py-2 px-3 hover:bg-pink-400 max-sm:w-[100%] '>Kids</li></Link>
                        </ul>
                    </div>
