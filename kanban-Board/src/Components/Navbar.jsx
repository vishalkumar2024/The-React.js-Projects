        ...
        <div  className=' iridescent-glass border border-transparent hover:border-zinc-100 rounded-4xl py-3 w-fit z-50 mx-auto  flex max-md:flex-col max-md:items-center max-md:gap-3 max-md:w-[90%]'>
            ...
            <div className='w-[250px] flex items-center'>
                <input
                    ...
                    className={`border-2 ${theme=="light"?"border-zinc-500 text-black":"border-zinc-300 text-gray-100"}  w-full pl-3 py-1 outline-none rounded-2xl`}
                />
            </div>

            <div className='flex item-center  px-4'>
                <div className={` flex items-center mr-2 ${theme=="light"?"  text-black":"  text-gray-200"}`}>
                    <Sun />
                </div>
                ...
                <div className={` flex  items-center mx-2 ${theme=="light"?"  text-black":"  text-gray-200"} `}>
                    <Moon />
                </div>
