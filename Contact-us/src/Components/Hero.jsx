        ...
        <div className='flex mt-6 max-md:flex-col'>
            ...
            <div className='w-1/2 max-md:w-full'>
                <div className='flex items-center justify-between'>
                    <button className='flex text-[1.05rem] px-[5%] py-[5%] mr-0.5 bg-black text-white uppercase rounded '> <span className='mr-3 mt-[5px] '><MdOutlineMessage /></span>  <p className=' max-lg:text-[0.7rem] max-md:text-[1rem]   max-[430px]:text-6xl'> View support chat
                    </p>
                    </button>

                    <button className='flex text-[1.05rem] px-[15%] py-[5%] bg-black text-white uppercase rounded'> <span className='mr-3 mt-[5px]'><IoMdCall /></span>  <p className=' max-lg:text-[0.7rem] max-md:text-[1rem]'> Via call
                    </p>
                    </button>
                </div>
